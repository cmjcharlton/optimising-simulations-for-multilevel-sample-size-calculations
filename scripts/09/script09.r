...
# Figure 11a
cutoff <- 0.8
figure11a <- ggplot(data = output, aes(x = N)) +
...
# Figure 11b
cutoff <- qnorm(0.8)
figure11b <- ggplot(data = output, aes(x = sqrtN)) +
...
figure11 <- figure11a + figure11b + plot_layout(guide = "collect") & theme(legend.position = "bottom")
ggsave("figure11.svg", plot=figure11, width=16, height=10, units="cm")
